...
- Name: batch-measurement-entry.spec.ts >> Quick Setup Wizard Tests >> should navigate through wizard steps with Next button
- Location: tests/e2e/batch-measurement-entry.spec.ts:515:3
