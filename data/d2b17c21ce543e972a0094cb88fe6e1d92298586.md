...
- Name: wellness-athlete-dropdown.spec.ts >> Wellness Athlete Dropdown Selector >> Submission with Selected Athlete >> should submit with selected athlete ID and store as real user
- Location: tests/e2e/wellness-athlete-dropdown.spec.ts:406:5
