...
- Name: batch-measurement-entry.spec.ts >> Quick Setup Wizard Tests >> should select multiple metrics in Step 2
- Location: tests/e2e/batch-measurement-entry.spec.ts:590:3
