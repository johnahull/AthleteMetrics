...
- Name: batch-measurement-entry.spec.ts >> Quick Setup Wizard Tests >> should generate grid rows when wizard is completed
- Location: tests/e2e/batch-measurement-entry.spec.ts:670:3
