...
- Name: batch-measurement-entry.spec.ts >> Quick Setup Wizard Tests >> should configure date and measurements per athlete in Step 3
- Location: tests/e2e/batch-measurement-entry.spec.ts:612:3
