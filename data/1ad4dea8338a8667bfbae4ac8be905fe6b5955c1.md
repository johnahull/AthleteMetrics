...
- Name: coaching-insights.spec.ts >> Coaching Insights - Org Admin Configuration >> should show disabled state when site admin has not enabled AI
- Location: tests/e2e/coaching-insights.spec.ts:109:3
