...
- Name: report-public-sharing.spec.ts >> Report Public Sharing - TDD Tests >> should access public report without authentication
- Location: tests/e2e/report-public-sharing.spec.ts:182:3
...
Locator: locator('text=Performance, text=Report')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Performance, text=Report')
