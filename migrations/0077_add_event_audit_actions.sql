-- Migration 0077: Add event system audit actions
-- Adds actions for: event CRUD, freeze/unfreeze, registration, invitations
...
BEGIN
  ...
  -- Recreate constraint with event actions added
  -- NOTE: This constraint must include ALL existing actions in the database
  -- Based on migration 0075 with event actions added
