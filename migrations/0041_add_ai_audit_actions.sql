-- Migration 0041: Add AI Feature Audit Actions
-- Purpose: Add audit log actions for AI feature management
...
COMMENT ON CONSTRAINT audit_logs_action_valid ON audit_logs IS
  'Valid audit log actions including AI feature management actions (updated in migration 0041)';
