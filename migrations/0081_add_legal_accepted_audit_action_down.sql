-- Migration 0081 DOWN: Remove legal_accepted audit action
-- Reverts to the constraint from migration 0080
...
BEGIN
  ...
  -- Recreate constraint WITHOUT legal_accepted (revert to 0080 state)
