-- Migration 0070: Add registration, membership request, and bulk measurement audit actions
-- Adds actions for: self-registration, membership requests, join code management, bulk verification
...
BEGIN
  ...
  ALTER TABLE audit_logs ADD CONSTRAINT audit_logs_action_valid CHECK (action IN (
    ...
    -- Membership request actions (new)
