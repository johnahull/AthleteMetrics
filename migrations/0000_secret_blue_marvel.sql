...
CREATE TABLE "measurements" (
	...
	"team_id" varchar,
	"season" text,
	"team_context_auto" text DEFAULT 'true',
	"created_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "measurements" ADD CONSTRAINT "measurements_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
