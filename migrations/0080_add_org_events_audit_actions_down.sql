-- Rollback Migration 0080: Remove org events audit actions
-- Restores audit_logs constraint to pre-0080 state (same as 0077 state)
...
BEGIN
  ...
  -- Recreate constraint without org events actions
  -- NOTE: This reverts to migration 0077 state
