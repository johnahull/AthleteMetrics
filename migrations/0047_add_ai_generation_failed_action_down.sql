...
-- This restores the constraint to its state after migration 0041
...
BEGIN
  ...
  IF EXISTS (
    ...
    -- Re-create with original actions from migration 0041 (without report_ai_insights_generation_failed)
