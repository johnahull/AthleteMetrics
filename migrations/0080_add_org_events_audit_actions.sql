-- Migration 0080: Add org events audit actions
-- For logging when org admins enable/disable the events feature
...
BEGIN
  ...
  -- Recreate constraint with org events actions added
  ALTER TABLE audit_logs ADD CONSTRAINT audit_logs_action_valid CHECK (action IN (
    ...
    -- Organization events actions (NEW)
    'org_events_enabled',
    'org_events_disabled',
