...
-- Using CONCURRENTLY to avoid blocking writes on large tables
-- Note: CONCURRENTLY cannot run inside a transaction, but the migration system handles this automatically
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_measurements_metric_org
