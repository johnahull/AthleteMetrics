-- Migration: 0025_add_parent_link_requests
-- Adds parent_link_requests table for the Phase 2 "Link a Child" workflow.
...
CREATE TABLE IF NOT EXISTS parent_link_requests (
  ...
  -- Requests expire if not acted upon (e.g. 30 days from creation)
