...
describe('ViolinChart', () => {
  ...
  const mockStatistics: Record<string, StatisticalSummary> = {
    'Team A': {
      ...
      variance: 0.0025,
      percentiles: {
        p5: 1.505, p10: 1.51, p20: 1.52, p25: 1.525, p30: 1.53, p40: 1.54,
        p50: 1.55, p60: 1.56, p70: 1.57, p75: 1.575, p80: 1.58, p90: 1.59, p95: 1.595
      }
    },
    'Team B': {
      mean: 1.75,
      ...
      variance: 0.0025,
      percentiles: {
        p5: 1.705, p10: 1.71, p20: 1.72, p25: 1.725, p30: 1.73, p40: 1.74,
        p50: 1.75, p60: 1.76, p70: 1.77, p75: 1.775, p80: 1.78, p90: 1.79, p95: 1.795
      }
    }
  };
