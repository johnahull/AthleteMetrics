...
const METRIC_EDUCATION: Record<string, MetricEducation> = {
  FLY10_TIME: {
    ...
    howToImprove: [
      'Feed the Cats flying sprints — build 10–20 yards then hit max velocity through the timing zone',
  ...
  VERTICAL_JUMP: {
    ...
    howToImprove: [
      'For volleyball: approach mechanics — penultimate step loading and arm swing timing add 2–4 inches to your approach jump',
  ...
  RSI: {
    ...
    howToImprove: [
      'Start with spring ankle work — pogo jumps and ankle stiffness drills before progressing to depth jumps',
      'Progress through BTA\'s plyometric tiers: pogos → hurdle hops → depth jumps',
      'Work on landing mechanics and immediate takeoff',
      'Develop tendon stiffness with isometric exercises',
      'Include reactive sprint work — sprint, decelerate, reactive sprint',
    ],
    sportRelevance: [
      'Volleyball',
      'Soccer',
