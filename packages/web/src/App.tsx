...
const CustomBenchmarkGroups = React.lazy(() => import("./pages/custom-benchmark-groups"));
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/organizations/:id/benchmark-groups">
        <RouteWrapper loadingText="Loading Custom Benchmark Groups...">
