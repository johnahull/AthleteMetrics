...
export function ChartContainer({
  ...
  const cardHeight = chartType === 'radar_chart' ? 'h-[900px]' : chartType === 'violin_plot' ? 'h-[910px]' : (chartType === 'box_swarm_combo' || chartType === 'time_series_box_swarm') ? 'h-[875px]' : 'h-[700px]';
