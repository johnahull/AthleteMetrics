...
describe('Logger Utility', () => {
  ...
  describe('log function', () => {
    ...
    it('should use 12-hour time format with AM/PM', () => {
      ...
      // Should not use 24-hour format (no hours like 13-23 at the start)
      // Check only the hour at the beginning of the string
      expect(logCall).not.toMatch(/^(1[3-9]|2[0-3]):/);
    });
